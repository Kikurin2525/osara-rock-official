...
この度、株式会社オサラロックは2025年8月15日、推し活・コスプレに特化した姫系セルフフォトスタジオ「Tiarina（ティアリナ）」の北千住店をグランドオープンいたしました。
...
この度、弊社は2024年11月1日をもちまして法人組織へと移行し、「株式会社オサラロック（Osara Rock Inc.）」として新たなスタートを切ることとなりました。
